        ...
        <div className="bg-[#F8F9FA] rounded-4xl lg:px-20 md:py-16 py-4">
          ...
          <div className="grid grid-cols-4 gap-10 mt-10 ">
            {filteredData?.map((doctor) => (
              ...
              >
                <div className="lg:h-[250px] h-[250px] relative before:absolute before:bottom-0 before:bg-gradient-to-t before:from-white before:to-transparent before:z-10 before:w-full before:h-[70%] before:right-0 ">
                  <Image
